package tcg.frontend.ui.usuario.market.selloffers.view
...
fun SellOffersView(
    ...
    val item = sellOffersViewModel.selected.collectAsState()
    ...
    Surface(
        ...
        Column(
            ...
            FlowRow(
                ...
                FilledTonalButton(onClick = { item.value?.let { onBuy(it) } }, enabled = ((userMainViewModel.user.value?.money ?: 0f) >= (item.value?.price ?: 999f))) {
