...
fun UserCardGallery(
    ...
    val mode by userCardGalleryViewModel.sellMode.collectAsState()
                ...
                if (state.errorMessage != null) {
                    ...
                    FlowRow(
                        ...
                        OutlinedButton(
                            ...
                            colors = if(mode) ButtonDefaults.outlinedButtonColors(contentColor = Color.Green) else ButtonDefaults.outlinedButtonColors(contentColor = MaterialTheme.colorScheme.primary)
                        ) {
                            Icon(
